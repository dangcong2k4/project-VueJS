        ...
        methods:{
            ...
            saveStudent() {
                if (this.validate()){
                    if (this.student.id){
                        console.log("ok")
                        StudentService.updateStudent(this.student.id,this.student.name,this.student.dateOfBirth,this.student.point).then(response =>{
            ...
            findByStudent(id){
                console.log(id)
                StudentService.findById(id).then(data=>{
